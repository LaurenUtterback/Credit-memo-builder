...
# --- Proposing the terms ---------------------------------------------------
#
# House defaults, taken from South River's own recent closed deals rather than
# invented: 15% / 4.0% / 6mo is typical, 13.5% / 3.0% / 6mo on the largest.
# They are STARTING POINTS the underwriter edits,
