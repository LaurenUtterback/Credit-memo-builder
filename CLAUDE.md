...
- `app/structure_extraction.py` + `POST /api/structure/extract` — reads the deal
  ...
  formatted money and percents ("$1,443,116", "15%"), normalizes `pay_frequency`
...
Validated against the real Joey Porter Jr. deal (2026-08-04 memo): $2,925,000 @
15%, 6-month balloon, guaranteed 2026 salary $1,443,116, other debt $327,768.
The engine reproduces the 18 NFL game checks (4+4+5+4+1 across Sep-Jan), prices
